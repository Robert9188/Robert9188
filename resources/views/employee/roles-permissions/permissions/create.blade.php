                            ...
                            <div class="container overflow-y-auto max-h-[65vh]">
                                <div class="flex flex-col items-center">
                                    <div class="w-full mb-10">
                                        <h1 class="text-2xl text-center text-indigo-500 font-bold uppercase">Create Permission</h1>
                                    </div>
                                    <div class="w-3/4">
                                        <form method="POST" action="{{ route('employee.permission.store') }}">
                                        @csrf
                                        ...
                                        <!-- Name and Display Name -->
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <textarea
                                                    ...
                                                    value="old('description')" required autofocus placeholder="Permission's description"></textarea>
                                            </div>
